...
function playerMoved(self) {
    self.currentClockData.delayRemainingInMillis = self.timeControls[self.currentClockData.currentTimeControlIndex].delayInMilliseconds;
    self.currentClockData.timeRemainingInMillis = self.currentClockData.timeRemainingInMillis + self.timeControls[self.currentClockData.currentTimeControlIndex].incrementInMillis;
